...
urlpatterns = [
    ...
    # path('feedback/edit/<int:feedback_id>/', edit_feedback_view, name='edit_feedback'),
    # path('feedback/delete/<int:feedback_id>/', delete_feedback_view, name='delete_feedback'),
